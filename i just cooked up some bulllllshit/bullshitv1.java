    ...
    public class Example2 {
            ...
            if (ch1.equals("yes") || ch1.equals("y")) {
                ...
                for (; ; ) {
                    ...
                    if (move.equals("info")) {
                        ...
                        int wait = 0;
                        turncalc( hp,  hp1,  c,  wait,  md,  buff,  buff2,  miss, axes, shield);
                        break;
                    }
                }
            }
        }
        public static void turncalc(double hp, double hp1, String c, int wait, double md, int buff, int buff2, int miss, int axes, boolean shield)  {
            int i = 1;
            Scanner scan = new Scanner(System.in);
            ...
            while (true) {
                ...
                for (; ; ) {
                    if (hp <= 0) {
                      System.out.println("you died would you like to try again");
                      System.out.println("Y/n");
                    ...
                    if ((i % 2) == 1 && (i > -1)) {
                        if (wait == 0) {
                            i++;
                            magedmg(hp, hp1, c, md, buff, shield, axes, buff2, miss);
                            break;
                        }
                        else if (wait == 1) {
                            i++;
                           ...
                           hp1 = hp1 - md;
                           //note to self make a new magedmg expect it checks a var then does it so we can make moves that take one turn
                        }
                    } else if ((i % 2) == 0 && (i > -1)) {
                        i++;
                        hp = edmgg(hp, hp1);
        ...
        public static double magedmg(double hp, double hp1, String c, double md, int buff, boolean shield, int axes, int buff2, int miss)  {
            Scanner scan = new Scanner(System.in);
        ...
        public static double edmgg(double hp, double hp1) {
                int iwabd = (int) (Math.random() * 15 + 1);
